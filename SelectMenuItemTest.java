...
public class SelectMenuItemTest {
	    ...
	    public static void main(String[] args) {
	    		...
	    		System.setProperty("webdriver.chrome.driver","D:\\\\PhatLam\\\\driver\\\\chromedriver.exe");
	    	...
	    	public static void selectMenuItemTest(String xyz, WebDriver driver) {
	    		...
	    		for (int i=0; i< childElements.size(); i++) {
	    			if (childElements.get(i).getText().equals(xyz)) {
